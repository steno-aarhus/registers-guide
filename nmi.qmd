...
codes) is in development; see [Comorbidity](11c_comorbidity.qmd) for the general
...
LPR](09b_extract-from-lpr.qmd): either extract **all** diagnoses and ATC codes
...
LPR](09b_extract-from-lpr.qmd) as in the example here:
...
You started from `full_cohort.rds` ([Phase 10](10_build-study-population.qmd):
...
5](05_extraction-step-by-step.qmd)) rather than restarting the whole R session.
...
nmi_data <- cohort %>%   # reload your cohort here if needed (the name may be something other than "cohort")
  ...
  mutate(
    nmi =
      ...
      13 * dx_K70_K767 +          # liver disease, weight 13
...
this automatically - see [Descriptive tables](13b_descriptive-tables.qmd).
...
Decide it in [Phase 1](01_plan-your-study.qmd) and apply it in [Phase
