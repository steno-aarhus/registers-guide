...
Du ankommer til denne fase med separate RDS-filer: din kohort fra [Fase 10](10_byg-studiepopulation.qmd) og de variable du har udtrukket i [Fase 11](11_udtraek-variable.qmd) - udfald, socioøkonomi og komorbiditet (plus evt. demografi fra [Fase 6](06_foerste-udtraek.qmd)). Du forlader med ét analyseklart datasæt klar til [Fase 13 - Analyse](13_analyse.qmd).
...
- **[Manglende data](12c_manglende-data.qmd):** hvordan du forstår og håndterer missing values, inkl. multipel imputation.
- **[Tidsvarierende variable](12d_tidsvarierende.qmd):** hvad du gør, når en variabel ændrer sig under opfølgningen (og hvornår du ikke behøver at gøre noget).
