...
Det skal du ikke med `read_register()` (fastreg) - de giver dig allerede en DuckDB-forbindelse, så `to_duckdb()`-konverteringen er indbygget. Hvornår du bruger hvad, kan du læse i [Fase 5 - Arrow vs. DuckDB](05_udtraek-trin-for-trin.qmd#arrow-vs-duckdb).
:::
...
Bruges når du vil gemme et R-datasæt som parquet-fil, fx til brug med `open_dataset()` eller `read_register()` i et andet script.
...
**Vigtigt:** kald det altid på samme linje som `open_dataset()` (eller `read_register()` i DARTER).
