...
10](build-study-population.qmd) shows how to build a matched cohort study.
...
- **Treatment strategies:** the exposure and its comparator, each defined clearly enough that a person could in principle be assigned either ([Comparison cohort](comparison-cohort.qmd)).
...
all, see [Time-varying variables](time-varying.qmd#feedback).
...
These are the same three conditions restated for weighting on the [IP weighting](weighting-iptw.qmd) page.
</details>
...
- **Who is an appropriate comparator?** Either an **active comparator**
  ...
  the question; expanded in [Comparison cohort](comparison-cohort.qmd).
...
Build your study population](build-study-population.qmd).
