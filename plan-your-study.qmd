...
**Cohort** follows persons forward in time from the index date and measures how many develop the outcome - which is why you can compute incidence and risk. Well suited when you have multiple outcomes (cf. the `all_dx` approach in [Extract from LPR](extract-from-lpr.qmd)).
