...
<details>
<summary>Value sets for the coded columns (11)</summary>
...
| `disco08` | Not listed here - see [DST's classification](https://www.dst.dk/da/Statistik/dokumentation/nomenklaturer/disco08) |
| `nace_db07` | Not listed here - see [DST's classification](https://www.dst.dk/da/Statistik/dokumentation/nomenklaturer/db07) |
...
| `branche_77` | Not listed here - see [DST's classification](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/BRANCHE-77) |
| `disco_old` | Not listed here - see [DST's classification](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/DISCOALLE-INDK) |
...
| `nace_old` | Not listed here - see [DST's classification](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/NACE) |
| `nystgr` | Not listed here - see [DST's classification](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/NYSTGR) |
...
- **`beskst02`:** [DST high-quality variable documentation: BESKST02](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/BESKST02).
- **`disco08`:** [DST's DISCO-08 classification](https://www.dst.dk/da/Statistik/dokumentation/nomenklaturer/disco08) ([the code list as CSV](https://www.dst.dk/klassifikationsbilag/27573556-f064-4660-946b-53ab7938ee2bcsv_da)).
- **`nace_db07`:** [DST's DB07 classification](https://www.dst.dk/da/Statistik/dokumentation/nomenklaturer/db07) ([the code list as CSV](https://www.dst.dk/klassifikationsbilag/5ccbf808-48a1-48ce-86b3-749115087feccsv_da)).
- **`beskst`:** [DST high-quality variable documentation: BESKST](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/BESKST).
- **`branche_77`:** [DST high-quality variable documentation: BRANCHE-77](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/BRANCHE-77).
- **`disco_old`:** [DST high-quality variable documentation: DISCOALLE_INDK](https://www.dst.dk/da/TilSalg/data-til-forskning/generelt-om-data/dokumentation-af-data/hoejkvalitetsvariable/Personers-tilknytning-til-arbejdsmarkedet-set-over-hele-aaret--AKM-/DISCOALLE-INDK).
