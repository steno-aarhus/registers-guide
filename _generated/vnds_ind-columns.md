<!-- Generated from schema/registers/vnds_ind.yaml by tools/build-schema-tables.R. Do not edit by hand. -->

| Column | Type | Role | Label | Years |
| --- | --- | --- | --- | --- |
| **`pnr`** | character | join key | Personal identifier | 2025 to 1900 |
| `haend_dato` | date | date | Date of immigration | 2025 to 1900 |
| `indv_land` | character | code | Country immigration from | 2025 to 1900 |
| `indvmd` | character | date | Month of immigration | 2025 to 1900 |
