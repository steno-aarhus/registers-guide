<!-- Generated from schema/registers/t_psyk_sksopr.yaml by tools/build-schema-tables.R. Do not edit by hand. -->
...
- **`c_oprart`:** '+' marks a supplementary code held in c_tilopr, the same add-on mechanism as lpr_diag.yaml's diagnosis add-on codes.
