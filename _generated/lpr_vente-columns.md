<!-- Generated from schema/registers/lpr_vente.yaml by tools/build-schema-tables.R. Do not edit by hand. -->
...
- **`d_vsldto`:** Read as the END date, following LPR2's own SLDTO=slut(end) naming convention - not independently labelled by DST for this column.
