---
title: "![](images/icons/icon_10.png){.title-icon} Self-controlled and family-based designs"
subtitle: "The person (or family) acts as their own control - so all time-invariant/shared confounding disappears without you measuring it"
date: last-modified
---
...
So far, comparison has been about finding a group to compare against - a [comparison cohort](10a_sammenligningskohorte.qmd) or matched [controls](10b_case-control.qmd) - and then adjusting for confounding. Two other designs turn that around: they let the **person themselves** (or the **family**) be the control, so all **time-invariant** confounding (what does not change over time: genes, fixed socioeconomic status (SES), unmeasured lifestyle) disappears without you having to measure it.
...
**R.** [The `SCCS` package](https://CRAN.R-project.org/package=SCCS) for self-controlled case series; case-crossover can be done as conditional logistic regression (`survival::clogit` with a `strata()` per person, see [Regression](13d_regression.qmd)).
...
**Analysis.** Conditional logistic regression or stratified Cox on the **family ID** - the same strata idea as matched [case-control](10b_case-control.qmd), just with the family as the matched set.
...
- Petersen, Douglas & Whitaker, "[Self controlled case series methods: an alternative to standard epidemiological study designs](https://www.bmj.com/content/354/bmj.i4515)", *BMJ* 2016;354:i4515 - an introduction to SCCS.
- [The `SCCS` package](https://CRAN.R-project.org/package=SCCS) - self-controlled case series in R.
- Frisell, "[Invited Commentary: Sibling-Comparison Designs, Are They Worth the Effort?](https://academic.oup.com/aje/article/190/5/738/5896191)", *Am J Epidemiol* 2021 - what sibling designs can and cannot do.
:::
