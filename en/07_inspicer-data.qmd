...
**1. Give your extraction a name.** If you just write `open_dataset(...)` (or `read_register(...)` in DARTER) without storing it in an object, R only prints a quick preview and throws the result away - there is nothing to inspect afterwards. Assign it a name with `<-` (see [Phase 2 - What is an object?](02_r-intro.qmd#hvad-er-et-objekt)) so you can reuse it.
