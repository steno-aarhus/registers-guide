...
This page supplements the [general DST pitfalls](../dst_faldgruber.qmd) with issues specific to the DARTER project.
...
- [General DST pitfalls](../dst_faldgruber.qmd): 10 pitfalls that apply to all projects
