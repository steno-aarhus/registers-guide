...
- [Joining data](https://www.epirhandbook.com/en/new_pages/joining_matching.html) in *The Epidemiologist R Handbook*.
- [Joins](https://r4ds.hadley.nz/joins.html) in *R for Data Science*: keys, mutating vs. filtering joins and what happens when a key has duplicates.
:::
