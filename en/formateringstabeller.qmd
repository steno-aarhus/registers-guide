...
If you are not familiar with joins yet, read [Phase 12 - Assemble and prepare the dataset](12_data-manipulation.qmd) first.
:::
...
- [Socioeconomic variables](11b_socioekonomiske-variable.qmd): SEPLINE approach with code examples for AKM, FAIK and UDDA
