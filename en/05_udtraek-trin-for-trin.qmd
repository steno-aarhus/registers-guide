...
hundreds of millions of rows and would crash your session. The lazy connection
...
BEF has millions of rows; LMDB has hundreds of millions. Calling `collect()`
...
from LPR ([Phase 9b](09b_udtraek_fra_lpr.qmd)), once the cohort itself is built
([Phase 10](10_byg-studiepopulation.qmd)). You don't need it yet.
:::
