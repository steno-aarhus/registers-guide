...
Vil du lære R, epidemiologi eller statistik, finder du en kurateret liste over kurser, bøger og opslagsværker i [Læringsressourcer](15e_laeringsressourcer.qmd).
...
Røret `%>%` forklares grundigt i [Funktioner: oversigt](15a_guide_til_funktioner.qmd#røret), og `collect()` i [Fase 5 — Udtræk trin for trin](05_universelle-moenster.qmd).
...
**Dele et lille udsnit af dine data?** Brug `dput(head(dine_data))` — det udskriver dataene som R-kode, andre kan kopiere direkte ind og køre. Del aldrig rigtige persondata — brug nogle få anonyme eller syntetiske rækker.
...
Du behøver ikke alt det nu — du møder det, når du skal skrive din egen analysekode. Den fulde gennemgang står i [Fase 12 — Skriv god analysekode](12_god-kode-praksis.qmd).
