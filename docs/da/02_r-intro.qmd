...
![](images/icons/icon_02.png){.chapter-icon fig-alt="Kapitelikon"}
...
Vil du lære R, epidemiologi eller statistik, finder du en kurateret liste over kurser, bøger og opslagsværker i [Fase 15 — Læringsressourcer](15e_laeringsressourcer.qmd).
...
Røret `%>%` forklares grundigt i [Fase 15 — Funktioner: oversigt](15a_guide_til_funktioner.qmd#røret), og `collect()` i [Fase 5 — Udtræk trin for trin](05_universelle-moenster.qmd).
