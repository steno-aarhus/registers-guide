...
Slå en funktion op med `?funktionsnavn`. Denne oversigt er blot et udsnit af den hjælp der kan findes fra DDEA-kursets hjælp til [fejlfinding](https://r-cubed-intro.rostools.org/appendix/troubleshooting).
