...
::: {.callout-note}
**Hvad betyder tegnene i `filter()`?** `,`/`&` = OG, `\|` = ELLER, `!` = IKKE, plus `==`, `!=`, `>`, `>=`, `%in%`. Fuld oversigt med eksempler og parentes-faldgruben: [Fase 15a — Kombinér betingelser i `filter()`](15a_guide_til_funktioner.qmd#filtrer-betingelser).
:::
