...
::: {.callout-note}
**Hvad betyder tegnene i `filter()`?** `,`/`&` = OG, `\|` = ELLER, `!` = IKKE, plus `==`, `!=`, `>`, `>=`, `%in%`. Fuld oversigt med eksempler og parentes-faldgruben: [Kombinér betingelser i `filter()`](15a_guide_til_funktioner.qmd#filtrer-betingelser).
:::
...
Mellemresultater hjemsendres via outputkontrol - se [14 - Eksport og hjemsendelse](16_eksport-hjemsendelse.qmd).
:::
...
- [Fase 12 - Saml & klargør datasættet](11_data-manipulation.qmd) - kobl to udtræk sammen
