...
Selve valget af test afhænger især af **datatypen** (numerisk, binær eller time-to-event), om data er **parrede eller uparrede**, og om antagelserne for en **parametrisk** test er opfyldt (ellers en nonparametrisk). Tabellerne nedenfor matcher forskellige situationer med en test/model og den tilsvarende **R**-kommando. Er begreberne nye, så fold dem ud under **Begreber kort**.
