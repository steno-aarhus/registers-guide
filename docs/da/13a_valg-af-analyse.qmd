...
**Start med dit spørgsmål.** Formulér først dit forskningsspørgsmål og din **nulhypotese** - de styrer resten. Spørg så: vil du **sammenligne grupper** eller **beskrive en sammenhæng**? (Det er grundlæggende det samme - at sammenligne grupper er at undersøge en sammenhæng mellem en gruppe-variabel og udfaldet.)

Selve valget af test afhænger især af **datatypen** (numerisk, binær eller time-to-event), om data er **parrede eller uparrede**, og om antagelserne for en **parametrisk** test er opfyldt (ellers en nonparametrisk). Tabellerne nedenfor matcher hver situation med en test/model og den tilsvarende **R**-kommando.
