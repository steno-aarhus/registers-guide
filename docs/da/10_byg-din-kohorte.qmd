...
![Tidslinje: index-dato (t₀) markerer start på opfølgning. Hver person følges til udfald eller censurering — det der kommer først; kovariater måles i baseline-vinduet før index.](images/index_matching.svg){fig-alt="Tidslinje med to eksempelpersoner: én der får udfaldet og én der censureres, begge med opfølgning fra index-dato." width="100%"}
