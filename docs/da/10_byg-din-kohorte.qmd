...
`inner_join()` og `bind_rows()` er vist i [Fase 9](09b_udtraek_fra_lpr.qmd). `group_by() + slice()` er vist kortfattet der og forklares grundigt i [Fase 12](11_data-manipulation.qmd).
:::
