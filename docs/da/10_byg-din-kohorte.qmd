...
Alle udtræk i de øvrige faser — udfald ([Fase 9](09_hospitalskontakter-lpr.qmd)), kovariater ([Fase 6](06_foerste-udtraek.qmd)) og socioøkonomi ([Fase 13](13_socioekonomiske-variable.qmd)) — forudsætter at du allerede har en kohorte: en tabel med `pnr` og `index_date` per person. Denne side viser, hvordan du bygger den fra bunden.
