...
De senere faser - udtræk af variable ([Fase 11](11_foej-variabler.qmd)), saml datasættet ([Fase 12](12_data-manipulation.qmd)) og analyse ([Fase 13](13_analyse.qmd)) - forudsætter, at du allerede har en **kohorte**: en tabel med `pnr` og `index_date` per person. Denne side viser, hvordan du identificerer din studiepopulation og giver hver person en index-dato; derefter vælger du studiedesign.
...
- **Prævalensstudie / kohorte uden sammenligningsgruppe** - efter denne side er du færdig med at bygge studiepopulationen; gå videre til [Fase 11 - Udtræk variable](11_foej-variabler.qmd).
...
Skal samme tjek bruges flere gange (fx også på en sammenligningsgruppe senere, se [Sammenligningskohorte](10a_sammenligningskohorte.qmd)), kan du pakke logikken i en funktion, så de to tjek ikke skrider fra hinanden. Se [God kode-praksis](12_god-kode-praksis.qmd).
...
# Hjælpe-funktion: hvilke pnr havde outcome FØR deres index-dato?
...
::: {.callout-tip}
`nrow()`, `cat()` og `stopifnot()` er forklaret i [Guide til funktioner](15a_guide_til_funktioner.qmd).
:::
...
- **Prævalensstudie / kohorte uden sammenligningsgruppe** - efter denne side er du færdig: du har din studiepopulation med en index-dato. Gå videre til [Fase 11 - Udtræk variable](11_foej-variabler.qmd) og [Fase 12 - Saml & klargør datasættet](12_data-manipulation.qmd).
