...
![Tidslinje: den eksponeredes index-dato (eksponeringsdato) tildeles den matchede sammenligningsperson. Opfølgningen løber fra index til hændelse eller censurering; kovariater måles i baseline-vinduet før index.](images/index_matching.svg){fig-alt="Tidslinje med en eksponeret og en sammenligningsperson, der deler index-dato; opfølgning frem til hændelse eller censurering." width="100%"}
