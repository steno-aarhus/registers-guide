...
Dine udtræk fra [Fase 6](06_foerste-udtraek.qmd), [Udtræk fra LPR](09b_udtraek_fra_lpr.qmd) og [Fase 11](11_foej-variabler.qmd) ligger som separate RDS-filer. Når hvert udtræk er nede på **én række per person** ([Langt ↔ bredt format](12a_langt-bredt.qmd)), kobler du dem sammen på `pnr` til ét analyseklart datasæt. Til sidst beregner du opfølgningstid og hændelsesvariabel.
