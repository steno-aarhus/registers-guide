...
1. **Definer den eksponerede kohorte.** Filtrér det register der definerer eksponeringen - fx bariatri-operationer via SKS-koder i `lpr_sksopr` / `procedurer_kirurgi` ([Udtræk fra LPR](09b_udtraek_fra_lpr.qmd)). Behold `pnr` og **index-dato** (operationsdatoen).
...
Selve **kohorteopbygningen og matchingen** med `heaven::riskSetMatch()` - inkl. faldgruber som immortal time - er i [Fase 10 - Byg din studiepopulation](10_byg-studiepopulation.qmd).
:::
