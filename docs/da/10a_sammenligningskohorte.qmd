...
`anti_join()` (behold rækker *uden* match) er ny her — se forklaringen i kodeblokken og i [Fase 12](12a_joins.qmd#joins-kobl-to-tabeller-sammen). `inner_join()`, `bind_rows()` og `group_by() + slice()` er vist i [Fase 9](09b_udtraek_fra_lpr.qmd) og [Fase 12](11_data-manipulation.qmd).
:::
