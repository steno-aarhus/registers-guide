...
`anti_join()` (behold rækker *uden* match) er ny her — se forklaringen i kodeblokken og i [Fase 11](11_data-manipulation.qmd#joins-kobl-to-tabeller-sammen). `inner_join()`, `bind_rows()` og `group_by() + slice()` er vist i [Fase 9](09b_udtraek_fra_lpr.qmd) og [Fase 11](11_data-manipulation.qmd).
:::
