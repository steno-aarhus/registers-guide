...
::: {.callout-tip}
`bind_rows()` her (der stabler de eksponerede og sammenligningsgruppen) og det `left_join()` du bruger bagefter til at koble udfald og kovariater på, er forklaret i [Kobl udtræk sammen](12b_joins.qmd#joins-kobl-to-tabeller-sammen).
:::
