...
::: {.callout-note}
**Lav en afledt variabel.** En ny variabel beregnes fra eksisterende kolonner med `mutate()` (uddybet i [Funktioner: oversigt](15a_guide_til_funktioner.qmd)). Alder ved index = antal dage mellem index og fødsel, delt med 365.25 (et år er 365.25 dage pga. skudår):
