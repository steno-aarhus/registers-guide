...
::: {.callout-tip}
**Læserækkefølge:** Læs denne side først for at forstå data. Gå derefter til [Udtræk fra LPR](09b_udtraek_fra_lpr.qmd) for de kørende kodeeksempler. Du bygger selve kohorten i [Fase 10](10_byg-din-kohorte.qmd).
:::
