...
::: {.callout-note}
Kodeeksemplerne bruger de kolonnenavne DST's parquet-registre typisk har. Dine kolonner kan hedde noget andet — tjek med `names(din_data)` eller slå dem op i [Fase 15 — Registerreference](15d_register_reference.qmd).
:::
