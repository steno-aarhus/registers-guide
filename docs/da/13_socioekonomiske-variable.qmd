...
- [Fase 15 — Formateringstabeller](15b_formateringstabeller.qmd) — DST's SAS-filer til label-oversættelse
- [Fase 15 — Registerreference](15d_register_reference.qmd) — bekræftede kolonnenavne for AKM, FAIK og UDDA
...
- **Specialpakker** (OSDC til diabetesklassifikation, NMI til comorbiditetsscore, analyseværktøjer)? → [Fase 14 — Pakker og specialfunktioner](14a_pakker-oversigt.qmd)
- **Klar til at eksportere resultater?** → [Fase 16 — Eksport og hjemsendelse](16_eksport-hjemsendelse.qmd)
