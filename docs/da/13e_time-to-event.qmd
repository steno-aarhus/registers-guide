...
Har du i forvejen separate 0/1-variable for udfald og død, så byg `status_kode` med `case_when()` (se [Fase 12](12_data-manipulation.qmd)): 0 hvis personen blev **censureret** (hverken udfald eller død set i opfølgningen - fx fulgt til opfølgningens slut, emigreret eller på anden vis tabt), 1 hvis udfald, 2 hvis personen døde først. Hvilket *tal* censurering får, er underordnet - det afgørende er, at det censurerede niveau står **først** i `levels =` (derfor er det kodet 0 her).
