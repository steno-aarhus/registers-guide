...
- **OSDC** — definér en diabetes-population, type og debutdato → [OSDC](14b_osdc.qmd)
- **NMI** — justér for comorbiditet i en model eller beskriv comorbiditetsbyrde → [NMI](14c_nmi.qmd)
- **SEPLINE** — uddannelse, indkomst, beskæftigelse som kovariater → [Socioøkonomiske variable](13_socioekonomiske-variable.qmd)
...
→ [Fase 14 — Eksport og hjemsendelse](16_eksport-hjemsendelse.qmd)
