...
- **OSDC** — definér en diabetes-population, type og debutdato → [Fase 14 — OSDC](14b_osdc.qmd)
- **NMI** — justér for comorbiditet i en model eller beskriv comorbiditetsbyrde → [Fase 14 — NMI](14c_nmi.qmd)
- **SEPLINE** — uddannelse, indkomst, beskæftigelse som kovariater → [Fase 13 — Socioøkonomiske variable](13_socioekonomiske-variable.qmd)
