...
```{mermaid}
flowchart TD
    A{"Hvor mange udfald<br>skal du trække fra LPR?"}
    A -->|"Ét / få"| B["Tilgang 1<br>direkte udtræk"]:::a1
    A -->|"Flere"| C["Tilgang 2<br>byg alle_dx én gang"]:::a2
    B --> D{"F-koder?<br>(psykiatri, fx demens)"}
    C --> D
    D -->|"Nej"| E["lpr_adm/lpr_diag +<br>lpr_a_kontakt/lpr_a_diagnose"]:::plain
    D -->|"Ja"| F["Tilføj også<br>t_psyk_adm / t_psyk_diag"]:::plain
