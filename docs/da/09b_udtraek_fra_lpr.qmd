...
::: {.callout-note}
**Cirkulær sammenhæng med Fase 10 - bevidst.** For at udtrække diagnoser (denne side) tænker vi, at du allerede har en kohorte; men du *bygger* kohorten i [Fase 10](10_byg-din-kohorte.qmd) med præcis det udtræksmønster, du lærer her. Læs faserne i rækkefølge, og kom tilbage til koden, når din kohorte er klar. Koden bruger `inner_join()` og `bind_rows()`; er de nye, forklares de grundigt i [Fase 12](11_data-manipulation.qmd).
:::
