...
Næsten al registerforskning er **observationel og analytisk** - du observerer det der allerede er sket, uden at gribe ind. De to klassiske analytiske designs er **case-control** og **kohorte**; [Fase 10](10_byg-din-kohorte.qmd) viser, hvordan du bygger et matchet kohortestudie. Randomiserede forsøg (RCT) kan ikke laves med registerdata og er kun taget med her for overblikkets skyld.
...
**Kohorte** følger personer fremad i tid fra index-dato og måler hvor mange der får udfaldet - derfor kan man beregne incidens og risiko. Velegnet når du har flere udfald (jf. `alle_dx`-tilgangen i [Fase 9b](09b_udtraek_fra_lpr.qmd)).
...
Med registerdata kan du gøre begge dele, fordi hele befolkningens historik er tilgængelig. [Fase 10](10_byg-din-kohorte.qmd) viser et **matchet kohortestudie** trin for trin.
...
En komplet beskrivelse af alle registre med kolonnenavne og join-nøgler finder du i [Register-overblik →](15d_register_reference.qmd)
...
- Baggrund: [Hernán & Robins, *Causal Inference: What If*](https://miguelhernan.org/whatifbook) (gratis PDF) - også i [Læringsressourcer](15e_laeringsressourcer.qmd).
:::
...
- **Hvem er en passende sammenligningskohorte?** Enten en **aktiv komparator** (uexponerede med samme indikation, fx samme grundsygdom men anden eller ingen behandling - reducerer confounding by indication) eller en matchet **baggrundsbefolkning** (maksimal kontrast). Valget afhænger af spørgsmålet; uddybes i [Fase 10a](10a_sammenligningskohorte.qmd).
