...
på dovne DuckDB-forbindelser. Se [Funktionsguiden](14a_guide_til_funktioner.qmd#bang-bang-to-udråbstegn) for fuld forklaring.
:::
...
|---|---|---|
| `nmi_score` | **Vægtet** comorbiditetsscore — Nordic Multimorbidity Index (Kristensen et al., *Clin Epidemiol* 2022). 50 prediktorer med individuelle vægte; lungekreft tæller f.eks. 19 point, type 2-diabetes tæller 2. | Se [NMI-siden](13c_nmi.qmd) |
...
| `Error in filter.default(...)` | Filtrering på et dovent objekt uden `%>%` | Skift til `%>%` — se [røret](14a_guide_til_funktioner.qmd#røret) |
