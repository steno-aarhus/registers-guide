...
Stierne i kodeeksemplerne (`E:/workdata/[projektnummer]/cleaned-data/parquet-registers/…`) følger denne struktur. Din konkrete mappe kan se anderledes ud - tjek med Stifinder. Hvordan du selv navngiver scripts i `R/`, gennemgås i [God kode-praksis](12_god-kode-praksis.qmd).
...
Du skriver stien til den parquet-mappe der indeholder registret - fx `open_dataset("sti/til/bef/")`. Hvilken sti det konkret er, afhænger af dit projekt og din server. Kolonnenavne for hvert register finder du i [Register-overblik](15d_register_reference.qmd).
...
Se [Konvertér SAS til parquet](#konvertér-sas-til-parquet) nedenfor for fremgangsmåden, og [Pas på RAM i det fælles miljø](12_god-kode-praksis.qmd#pas-på-ram) for de praktiske vaner.
