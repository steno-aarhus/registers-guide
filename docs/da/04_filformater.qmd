...
Gem **aldrig** rå registerdata som CSV — kun aggregerede resultater. Se [Fase 15 — Eksport og hjemsendelse](16_eksport-hjemsendelse.qmd) for reglerne.
...
Se [Konvertér SAS til parquet](#konvertér-sas-til-parquet) nedenfor for fremgangsmåden, og [Fase 12 — Pas på RAM i det fælles miljø](12_god-kode-praksis.qmd#pas-på-ram) for de praktiske vaner.
