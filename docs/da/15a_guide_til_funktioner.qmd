...
Det, du skriver inde i parentesen, kaldes **argumenter**. Mange funktioner har *navngivne* argumenter, hvor navnet fortæller, hvad værdien styrer, fx `ratio = 5` eller `na.rm = TRUE`. Du behøver ikke kende dem udenad: `?funktionsnavn` viser, hvilke argumenter en funktion tager, og hvad de gør.
