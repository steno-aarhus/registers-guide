...
*(CRAN; `install.packages("fastreg")` - [dp-next.github.io/fastreg](https://dp-next.github.io/fastreg/))*

Det anbefalede værktøj til at konvertere SAS-registre til parquet. Den **konverterer** (`convert()`, partitioneret efter år, med en `use_template()`-targets-pipeline til hele dit workspace) og **læser ind igen** (`read_register("bef")` giver en doven DuckDB-forbindelse og læser alle årlige undermapper som ét datasæt). Sæt `options(fastreg.project_rawdata_dir=, fastreg.project_workdata_dir=)` én gang, og referér derefter til registre via navn. Se [Fase 4 - SAS → parquet](04_filformater.qmd#konvertér-sas-til-parquet).
...
*(CRAN; altid tilgængelig - [cran.r-project.org/package=survival](https://cran.r-project.org/package=survival))*
...
*(CRAN, bekræftet på DST v3.3.3 - [github.com/bozenne/BuyseTest](https://github.com/bozenne/BuyseTest))*
...
Værktøjer fra [analysesektionen](13_analyse.qmd) ud over `survival` og `gtsummary` ovenfor. De fleste er på CRAN; bekræft tilgængelighed på DST før brug.
...
- [Suggested packages](https://www.epirhandbook.com/en/new_pages/packages_suggested.html)
:::
