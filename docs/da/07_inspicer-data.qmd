...
En oversigt over hyppige fejlbeskeder og hvad de typisk betyder finder du i [Faldgruber på DST](15c_dst_faldgruber.qmd#de-hyppigste-fejlbeskeder-og-hvad-de-betyder).
...
Se [Faldgruber på DST](15c_dst_faldgruber.qmd#4-datokolonner-er-ikke-altid-i-date-format) for de hyppigste datokonverteringsfejl og hvordan du retter dem.
...
- [Funktioner: oversigt](15a_guide_til_funktioner.qmd) - `filter()`, `select()`, `mutate()`, `left_join()` og mere
- [`dataReporter`](14a_pakker-oversigt.qmd#datareporter-automatisk-datakvalitetsrapport) - genererer automatisk en HTML-rapport over alle kolonner (fordeling, missingness, outliers). Bekræftet på DST.
