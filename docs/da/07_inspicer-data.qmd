...
En oversigt over hyppige fejlbeskeder og hvad de typisk betyder finder du i [Fase 15c — Faldgruber på DST](15c_dst_faldgruber.qmd#de-hyppigste-fejlbeskeder-og-hvad-de-betyder).
...
Se [Fase 15c — Faldgruber](15c_dst_faldgruber.qmd#4-datokolonner-er-ikke-altid-i-date-format) for de hyppigste datokonverteringsfejl og hvordan du retter dem.
...
- [Fase 15a — Funktioner: oversigt](15a_guide_til_funktioner.qmd) — `filter()`, `select()`, `mutate()`, `left_join()` og mere
