...
::: {.callout-tip}
**Leder du efter "hvilket register indeholder X?"** — start med beslutningstabellen i [Fase 8 — Find dine registre](08_kend-dine-registre.qmd). Denne side er den dybe reference med fulde kolonnenavne, typer og kodeeksempler.
:::
