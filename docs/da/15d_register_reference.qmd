...
### lpr_sksube — SKS-undersøgelser (ZZ-koder)

Undersøgelses-/underprocedurekoder (ZZ-koder) ligger i `lpr_sksube`, adskilt fra operationskoderne ovenfor. Join som de øvrige SKS-tabeller — via `recnum` (LPR2). Mindre brugt, og kolonnenavne er ikke verificeret her — slå op i [DST's variabelliste](https://www.dst.dk/extranet/forskningvariabellister/Oversigt%20over%20registre.html) og bekræft med `colnames()`.
