...
This page is your decision table. Once you know which register to use, you find the exact column names, types and code examples in [Overview of registers](register_reference.qmd).
...
Confirmed column names and join examples for each register are in [Overview of registers](register_reference.qmd).
...
- **Need the exact column names, types and code examples?** → [Overview of registers](register_reference.qmd)
