...
This page is your decision table. Once you know which register to use, you find the exact column names, types and code examples in [Phase 14 — Register reference](14d_register_reference.qmd).
...
| A surgical procedure / SKS code (up to 2018) | lpr_sksopr | `c_opr`, `recnum` |
| A surgical procedure / SKS code (2019 onwards) | procedurer_kirurgi | `procedurekode`, `dw_ek_forloeb` |
...
| `procedurer_kirurgi` | `dw_ek_forloeb` | `lpr_a_kontakt` |

Confirmed column names and join examples for each register are in [Phase 14 — Register reference](14d_register_reference.qmd).
...
- **Need the exact column names, types and code examples?** → [Phase 14 — Register reference](14d_register_reference.qmd)
- **Need to extract hospital diagnoses?** → [Phase 9 — Hospital contacts (LPR)](09_hospitalskontakter-lpr.qmd)
