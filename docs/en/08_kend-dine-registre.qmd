---
title: "![](images/icons/icon_08.png){.title-icon} Know your registers"
...
| A laboratory result (e.g. HbA1c) | lab_forsker | `pnr`, NPU code — see variable list |
...
|---|---|---|
| BEF, DODSAARS, VNDS, LMDB, UDDA, AKM, The Cancer Register, sysi/sssy, lab_forsker | `pnr` | All other `pnr` registers |
