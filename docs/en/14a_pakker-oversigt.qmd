...
- **OSDC** — define a diabetes population, type and onset date → [Phase 14 — OSDC](14b_osdc.qmd)
- **NMI** — adjust for comorbidity in a model or describe comorbidity burden → [Phase 14 — NMI](14c_nmi.qmd)
- **SEPLINE** — education, income, employment as covariates → [Phase 13 — Socioeconomic variables](13_socioekonomiske-variable.qmd)
