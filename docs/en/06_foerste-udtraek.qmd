...
This example uses `lpr_adm` (hospital contacts — contact dates only, no diagnosis join). When working with **diagnosis data from LPR** (ICD codes), additional rules apply: the register is split into two periods (LPR2 and LPR3), codes have a D-prefix that must be removed, and you must choose diagnosis types. All of this is covered in [Phase 9 — Hospital contacts (LPR)](09_hospitalskontakter-lpr.qmd).
:::
...
- [Phase 9 — Hospital contacts (LPR)](09_hospitalskontakter-lpr.qmd) — the complete pattern for diagnosis extractions
