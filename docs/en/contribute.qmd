...
2. **Find the file.** Every page is a `.qmd` file under `docs/da/` (Danish) and `docs/en/` (English) - e.g. this page is `docs/en/contribute.qmd`. Just edit whichever language you're comfortable with; we'll take care of the other.
