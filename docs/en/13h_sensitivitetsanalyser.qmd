...
subtitle: "How robust is your estimate? Vary the assumptions, and probe for unmeasured confounding"
date: last-modified
---

::: {.callout-warning}
**Under development.** This page shows minimal, verified examples. More detail to come.
:::
...
## Vary your choices (robustness checks)
...
Active comparator is about **how you build the cohort** (Phase 10) - see the new-user and risk-set logic in [Comparison cohort](10a_sammenligningskohorte.qmd).

::: {.callout-note}
**Self-controlled designs** (where the person is their own control and all *time-invariant* confounding disappears) are a related, powerful trick in register research. See [Self-controlled and family-based designs](10c_specielle-designs.qmd).
:::
...
- [Hernán & Robins, *Causal Inference: What If*](https://miguelhernan.org/whatifbook) - the causal foundation under confounding and sensitivity analyses (free PDF).
- Lund, Richardson & Stürmer, "[The Active Comparator, New User Study Design in Pharmacoepidemiology](https://link.springer.com/article/10.1007/s40471-015-0053-5)", *Curr Epidemiol Rep* 2015 - active comparator and new-user design.
- Lipsitch, Tchetgen Tchetgen & Cohen, "[Negative controls: a tool for detecting confounding and bias in observational studies](https://doi.org/10.1097/EDE.0b013e3181d61eeb)", *Epidemiology* 2010 - an introduction to negative controls (uses exactly the influenza vaccine example above).
:::
