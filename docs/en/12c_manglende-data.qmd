...
- **Missing outcome:** here imputation gains least. If you impute *only* the outcome from the same variables already in the analysis model, you typically end up with the same result as complete-case. A real gain requires extra auxiliary variables that predict the outcome. An alternative is **inverse probability weighting** (IPCW), see [IP weighting](13g_vaegtning-iptw.qmd).
