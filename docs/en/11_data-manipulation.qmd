...
You arrive at this phase with separate RDS files: your cohort from [Phase 10](10_byg-din-kohorte.qmd), event dates from [Phase 9](09b_udtraek_fra_lpr.qmd), covariates from [Phase 6](06_foerste-udtraek.qmd) and socioeconomic variables from [Socioeconomic variables](13_socioekonomiske-variable.qmd). You leave with one analysis-ready dataset ready for [Algorithms & special packages](14a_pakker-oversigt.qmd).
...
→ [Socioeconomic variables](13_socioekonomiske-variable.qmd)
