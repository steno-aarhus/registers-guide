...
::: {.callout-warning}
All three registers are **annual**. Fetch the variable for the **year before index date** (your cohort's entry date — e.g. surgery or diagnosis date), as register data for a given year typically describes status at year-end.
:::
...
- [Phase 15 — Format tables](15b_formateringstabeller.qmd) — DST's SAS files for label translation
- [Phase 15 — Register reference](15d_register_reference.qmd) — confirmed column names for AKM, FAIK and UDDA
...
- **Specialist packages** (OSDC for diabetes classification, NMI for comorbidity score, analysis tools)? → [Phase 14 — Packages and specialist functions](14a_pakker-oversigt.qmd)
- **Ready to export results?** → [Phase 16 — Export and repatriation](16_eksport-hjemsendelse.qmd)
