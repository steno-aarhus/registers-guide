...
![](images/icons/icon_01.png){.chapter-icon fig-alt="Chapter icon"}
...
A complete description of all registers with column names and join keys is in [Phase 15 — Register reference →](15d_register_reference.qmd)
...
- Background: [Hernán & Robins, *Causal Inference: What If*](https://miguelhernan.org/whatifbook) (free PDF) — also in [Phase 15 — Learning resources](15e_laeringsressourcer.qmd).
:::
