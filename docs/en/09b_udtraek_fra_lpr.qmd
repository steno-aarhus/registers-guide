...
::: {.callout-note}
The code uses `inner_join()` and `bind_rows()`. If these are new concepts, they are explained in detail in [Phase 12 — Assemble and prepare the dataset](11_data-manipulation.qmd) — you can follow the code here and return to Phase 12 afterwards.
:::
