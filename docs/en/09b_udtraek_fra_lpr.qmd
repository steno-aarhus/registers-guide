...
::: {.callout-note}
The examples require parquet files and a completed study population. `kohort` is the data.frame with `pnr` and `index_date` per person - see [Phase 10](10_byg-din-kohorte.qmd).
