...
An overview of common error messages and what they typically mean is in [DST pitfalls](15c_dst_faldgruber.qmd#the-most-common-error-messages-and-what-they-mean).
...
See [DST pitfalls](15c_dst_faldgruber.qmd#4-date-columns-are-not-always-in-date-format) for the most common date conversion errors and how to fix them.
...
- [Phase 8 - Find your registers](08_kend-dine-registre.qmd) - decision table: which register contains what
- [Functions: overview](15a_guide_til_funktioner.qmd) - `filter()`, `select()`, `mutate()`, `left_join()` and more
