...
::: {.callout-tip}
**Looking for "which register contains X?"** - start with the decision table in [Phase 8 - Find your registers](08_kend-dine-registre.qmd). This page is the deep reference with full column names, types and code examples.
:::
