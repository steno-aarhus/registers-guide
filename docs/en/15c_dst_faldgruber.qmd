...
::: {.callout-tip}
More practical habits (save often, partial loading, Task Manager) in [Phase 12 — Mind your RAM in the shared environment](12_god-kode-praksis.qmd#mind-your-ram), and DST's official advice in [DST guide: Reducing RAM use in the shared environment (PDF, Danish)](https://www.dst.dk/Site/Dst/SingleFiles/GetArchiveFile.aspx?fi=4500415120635&fo=0&ext=forskning).
:::
...
on lazy DuckDB connections. See [Functions guide](15a_guide_til_funktioner.qmd#bang-bang-two-exclamation-marks) for full explanation.
:::
...
|---|---|---|
| `nmi_score` | **Weighted** comorbidity score — Nordic Multimorbidity Index (Kristensen et al., *Clin Epidemiol* 2022). 50 predictors with individual weights; lung cancer counts e.g. 19 points, type 2 diabetes counts 2. | See [NMI page](14c_nmi.qmd) |
...
| `Error in filter.default(...)` | Filtering on a lazy object without `%>%` | Switch to `%>%` — see [the pipe](15a_guide_til_funktioner.qmd#the-pipe) |
