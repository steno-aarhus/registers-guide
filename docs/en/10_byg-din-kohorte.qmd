...
The later phases - extract variables ([Phase 11](11_foej-variabler.qmd)), assemble the dataset ([Phase 12](11_data-manipulation.qmd)) and analysis ([Phase 13](13_analyse.qmd)) - assume you already have a **cohort**: a table with `pnr` and `index_date` per person. This page shows how to identify your study population and give each person an index date; then you choose a study design.
...
- **Prevalence study / cohort without a comparison group** - after this page you are done: you have your study population with an index date. Continue to [Phase 11 - Extract variables](11_foej-variabler.qmd) and [Phase 12 - Assemble and prepare the dataset](11_data-manipulation.qmd).
