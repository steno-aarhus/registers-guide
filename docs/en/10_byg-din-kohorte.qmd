...
This page shows an active cohort study with matching — one exposed group and one comparator cohort. Adapt step 1 to your exposure definition: SKS code, ICD diagnosis, ATC code, clinical measurement or other. See [Phase 1 — what type of study](01_studieforberedelse.qmd#studietype) for the overview of case-control vs. cohort.
:::
