...
All extractions in the other phases — outcomes ([Phase 9](09b_udtraek_fra_lpr.qmd)), covariates ([Phase 6](06_foerste-udtraek.qmd)) and socioeconomics ([Phase 13](13_socioekonomiske-variable.qmd)) — assume you already have a cohort: a table with `pnr` and `index_date` per person. This page shows how to identify your study population; then you choose a study design.

::: {.callout-tip}
**In short:** First you identify your **cases/exposed** and give each an **index date**. After that, the path depends on your design:

- **Prevalence study / cohort without a comparison group** — you are done here; continue to [Phase 6](06_foerste-udtraek.qmd) and [Phase 11](11_data-manipulation.qmd).
...
Adapt the identification below to your exposure or case definition: SKS code, ICD diagnosis, ATC code, clinical measurement or other. See [Phase 1 — what type of study](01_studieforberedelse.qmd#studietype) for the overview of case-control vs. cohort.
:::

::: {.callout-note}
**Functions used here.**
`inner_join()` and `bind_rows()` are shown in [Phase 9](09b_udtraek_fra_lpr.qmd). `group_by() + slice()` is shown briefly there and explained in detail in [Phase 11](11_data-manipulation.qmd).
:::
...
- **Prevalence study / cohort without a comparison group** — you now have your study population with an index date. Continue to [Phase 6 — Extract covariates](06_foerste-udtraek.qmd) and [Phase 11 — Assemble the dataset](11_data-manipulation.qmd).
