...
All extractions in the other phases — outcomes ([Phase 9](09_hospitalskontakter-lpr.qmd)), covariates ([Phase 6](06_foerste-udtraek.qmd)) and socioeconomics ([Phase 13](13_socioekonomiske-variable.qmd)) — assume you already have a cohort: a table with `pnr` and `index_date` per person. This page shows how to build it from scratch.
