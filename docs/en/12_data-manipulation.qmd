...
You arrive at this phase with separate RDS files: your cohort from [Phase 10](10_byg-studiepopulation.qmd) and the variables you extracted in [Phase 11](11_foej-variabler.qmd) - outcomes, socioeconomics and comorbidity (plus demographics from [Phase 6](06_foerste-udtraek.qmd) if relevant). You leave with one analysis-ready dataset ready for [Phase 13 - Analysis](13_analyse.qmd).
