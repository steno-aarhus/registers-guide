...
You can read more about functions - arguments, default values and when they pay off - in [Functions: overview](guide_til_funktioner.qmd).
...
- [Phase 12 - Assemble and prepare the dataset](12_data-manipulation.qmd): joins and pivots
- [Functions: overview](guide_til_funktioner.qmd): functions in depth
- [Phase 5 - Extracting data step by step](05_udtraek-trin-for-trin.qmd): the fundamental pattern
