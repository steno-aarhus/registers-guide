...
::: {.callout-tip}
**In short:** The habits that matter most — one script per step, run each script top to bottom (never across), give objects meaningful names, and comment the *why* rather than the *what*. The rest is polish.
:::

::: {.callout-tip}
**You do not have to do everything at once.** Take a couple of these tips at a time and let them become habits. The most important thing is consistency — pick one style and stick to it.
:::
...
You can read more about functions — arguments, default values and when they pay off — in [Phase 15 — Guide to functions](15a_guide_til_funktioner.qmd).
...
- [Phase 11 — Assemble your extracts](11_data-manipulation.qmd) — joins and pivots
- [Phase 15 — Guide to functions](15a_guide_til_funktioner.qmd) — functions in depth
