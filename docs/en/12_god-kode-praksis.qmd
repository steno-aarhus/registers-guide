---
title: "Write good analysis code"
...
**A predictable order *within* each script.** An analysis script should follow the same structure every time:
...
The header at the top tells you in five seconds what the script does, who wrote it and what it needs. Section headings made with **CTRL+SHIFT+R** (they look like `# Load packages ----`) appear in the **outline panel** in the top right of the editor — click to jump straight to a section.
...
The code already shows *what* happens. A good comment explains *why* — the decision behind it.
