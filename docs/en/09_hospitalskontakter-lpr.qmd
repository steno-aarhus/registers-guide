...
::: {.callout-note}
The code examples use the column names DST's parquet registers typically have. Your columns may be named differently — check with `names(your_data)` or look them up in [Phase 15 — Register reference](15d_register_reference.qmd).
:::
...
- [Phase 15 — Register reference](15d_register_reference.qmd) — confirmed column names for all LPR registers
- [Phase 15 — Pitfalls](15c_dst_faldgruber.qmd) — known issues with LPR on DST
