...
::: {.callout-tip}
`bind_rows()` here (stacking the exposed and the comparison group) and the `left_join()` you use next to attach outcomes and covariates are explained in [Link your extracts](12b_joins.qmd#joins-link-two-tables).
:::
