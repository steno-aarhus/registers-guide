...
::: {.callout-tip}
**Working with rates per person-year?** If you compare **incidence rates** split by e.g. age groups or calendar periods (rather than time-to-first-event), you use **Poisson regression**, which gives an **incidence rate ratio (IRR)**. See [Rates and rate ratios (Poisson)](13f_rater-poisson.qmd) for when to choose it over Cox.
:::
...
New to the underlying statistics (what a test, p-value or confidence interval actually means)? See [*Learning Statistics with R* (Navarro)](https://learningstatisticswithr.com/) - a beginner-friendly walkthrough of the theory behind them.
:::
