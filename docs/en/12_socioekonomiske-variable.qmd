...
- [Phase 14 — Format tables](14b_formateringstabeller.qmd) — DST's SAS files for label translation
- [Phase 14 — Register reference](14d_register_reference.qmd) — confirmed column names for AKM, FAIK and UDDA
...
- **Specialist packages** (OSDC for diabetes classification, NMI for comorbidity score, analysis tools)? → [Phase 13 — Packages and specialist functions](13a_pakker-oversigt.qmd)
- **Ready to export results?** → [Phase 15 — Export and repatriation](15_eksport-hjemsendelse.qmd)
